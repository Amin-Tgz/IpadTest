...
export const LIVING_LINE_HERO: LivingLineHeroDefinition = {
  ...
  joints: [
    ...
    { id: "left_index_tip", x: -55, y: 0, parent: "left_hand" },
    { id: "left_thumb_tip", x: -48, y: 9, parent: "left_hand" },
    ...
    { id: "right_index_tip", x: 56, y: 1, parent: "right_hand" },
    { id: "right_thumb_tip", x: 49, y: 10, parent: "right_hand" },
  ...
  paths: [
    ...
    { id: "hero_left_index", part: "left_index_finger", width: 3.8, points: cubic({ x: -41, y: 2 }, { x: -45, y: -1 }, { x: -51, y: -2 }, { x: -55, y: 0 }, 8) },
    { id: "hero_left_thumb", part: "left_thumb", width: 3.8, points: cubic({ x: -41, y: 3 }, { x: -44, y: 8 }, { x: -47, y: 10 }, { x: -48, y: 9 }, 8) },
    { id: "hero_right_index", part: "right_index_finger", width: 3.8, points: cubic({ x: 42, y: 3 }, { x: 46, y: 0 }, { x: 52, y: -1 }, { x: 56, y: 1 }, 8) },
    { id: "hero_right_thumb", part: "right_thumb", width: 3.8, points: cubic({ x: 42, y: 4 }, { x: 45, y: 9 }, { x: 48, y: 11 }, { x: 49, y: 10 }, 8) },
